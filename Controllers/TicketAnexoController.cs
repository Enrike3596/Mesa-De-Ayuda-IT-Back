...
namespace Controllers
{
    ...
    {
        private readonly ITicketAnexoService _service;

        public TicketAnexoController(ITicketAnexoService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Crear([FromBody] TicketAnexoCreateDTO dto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Actualizar(int id, [FromBody] TicketAnexoUpdateDTO dto)
        {
